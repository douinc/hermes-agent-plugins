...
| [`discord_meeting`](discord_meeting/) | Follow people into a Discord voice channel, transcribe the meeting to disk, stay silent unless addressed, and let the agent summarise it later from any text channel. | ✅ |
